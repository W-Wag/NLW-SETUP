        ...
        <div className="w-full flex ">
            <div className="grid grid-rows-7 grid-flow-row gap-3">
                {weekDays.map((weekDay, i)=>{
                    return(
                     <div key={`${weekDay}- ${i}`} className="text-zinc-400 text-xl h-10 w-10 items-center justify-center">
                     {weekDay}
                 </div>
                    )
                })}
            ...
            <div className="grid grid-rows-7 grid-flow-col gap-3 ">
               ...
               {amountOfDaysToFull > 0 && Array.from({ length: amountOfDaysToFull}).map((_, i) => {
                return(
